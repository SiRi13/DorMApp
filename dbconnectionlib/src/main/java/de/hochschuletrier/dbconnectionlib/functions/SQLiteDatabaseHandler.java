...
public class SQLiteDatabaseHandler extends SQLiteOpenHelper
{
    ...
    {
        for (String table : EnumSqLite.tables) {
            Log.v(TAG, EnumSqLite.valueOf(table).getName());
            db.execSQL(EnumSqLite.valueOf(table).getName());
        }
    }
    ...
    * */
    ...
    public Map<String, String> getUserDetails() {
        ...
        if (cursor.getCount() > 0)
        {
            ...
            user.put(EnumSqLite.KEY_USERNAME.getName(), cursor.getString(4));
...
*/
    ...
    public void addUser(String fname, String lname, String email, String uname,
        ...
        values.put(EnumSqLite.KEY_USERNAME.getName(), uname); // UserName
